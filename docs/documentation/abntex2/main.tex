...
\newacronym{fk}    {FK}      {\emph{Foreign Key} – Chave Estrangeira}
...
\newacronym{pk}    {PK}      {\emph{Primary Key} – Chave Primária}
...
\newacronym{tads}  {TADS}    {Tecnologia em Análise e Desenvolvimento de Sistemas}
