...
% ---
% Pacotes básicos 
% ---ackage{lmodern}			% Usa a fonte Latin Modern			
...
\usepackage[section]{placeins} % cria barreira automática por seção
\usepackage[T1]{fontenc}
\usepackage{lmodern} % Latin Modern (Type 1/OT1 escalável)
...
\newacronym{ssl}   {SSL}     {\emph{Secure Sockets Layer}}
...
% ----------------------------------------------------------
	...
	\input{cap03-gestao/03-00-gestao-projeto.tex}
	...
	\input{cap04-desenvolvimento/04-00-desenvolvimento}
	
	% ----------------------------------------------------------
	\cleardoublepage
	\chaptermark{VIABILIDADE FINANCEIRA}
	\chapter{VIABILIDADE FINANCEIRA}
	\input{cap05-viabilidade/05-00-viabilidade-financeira.tex}
	...
	% ---
	\begin{apendicesenv}
		\partapendices % página inicial "Apêndices"
		
		\chapter{Certificação SSL do Domínio} % título do apêndice
		\label{app:ssl}
		
	\cleardoublepage
	\includepdf[
	pages=-,
	scale=0.95,                  % ajuste fino 0.9–0.97
	pagecommand={\thispagestyle{plain}},
	offset=0 -1cm,               % empurra para baixo (y negativo)
	fitpaper=true
	]{cap04-desenvolvimento/images/SSL-apendice.pdf}
	
\chapter{Testes de Integração}
\label{app:integracao}
\begin{figure}[htbp]
	\centering
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[height=0.22\textheight]{cap04-desenvolvimento/images/teste1.jpeg}
		\caption{Teste 1}
	\end{subfigure}\par\vspace{0.4em}
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[height=0.22\textheight]{cap04-desenvolvimento/images/teste2.jpeg}
		\caption{Teste 2}
	\end{subfigure}\par\vspace{0.4em}
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[height=0.22\textheight]{cap04-desenvolvimento/images/teste3.jpeg}
		\caption{Teste 3}
	\end{subfigure}\par\vspace{0.4em}
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[height=0.22\textheight]{cap04-desenvolvimento/images/teste4.jpeg}
		\caption{Teste 4}
	\end{subfigure}
	\caption{Resultados dos testes de integração}
	\label{fig:testes-vert}
\end{figure}
