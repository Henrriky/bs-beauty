...
\newacronym{ssl}   {SSL}	 {\emph{Secure Sockets Layer} - Camada de Soquete Seguro}
...
% ----------------------------------------------------------
	...
	\begin{apendicesenv}
		...
		\input{apendices/apendice-testes-unitarios.tex}
		
		\input{apendices/apendice-links-projeto.tex}
