...
Atualmente mantém mais de 10 mil assinantes, com maior incidência nas regiões Sul e Sudeste do Brasil. Foi criado no modelo \gls{saas} com o intuito de oferecer prontamente agenda \emph{on-line}, automação de lembretes (\emph{e-mail/WhatsApp}), módulo financeiro completo e integrações com \emph{gateways} de pagamento (Stone, Cielo e Mercado Pago). Atualmente, os planos são somente pagos e variam de R\$ 32 a R\$ 293/mês, após 14 dias de teste gratuito \cite{Gendo}.
...
\begin{quadro}[htb]
	...
	\begin{tabular}{|p{6.8cm}|c|c|c|c|}
		\hline
		\rowcolor{myblue}\textbf{Recurso} & \textbf{Trinks} & \textbf{Gendo} & \textbf{Avec} & \textbf{\emph{BS Beauty}}
		\\ \hline
