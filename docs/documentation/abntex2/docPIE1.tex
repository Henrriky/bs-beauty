...
%adicionar algo desta matéria da beautyfair que é a maior feira de beleza brasil. https://negociosdebeleza.beautyfair.com.br/coworkings-de-beleza/ 
	% ----------------------------------------------------------
% o input do capitulo 1 já contem todas as seções dele	
\input{cap01-Introducao/1.Introducao}
	% --------------------------------------
	...
	\input{cap02-Revisao_literatura/2.Revisao_literatura}	
	%  ----------------------------------------------------------
