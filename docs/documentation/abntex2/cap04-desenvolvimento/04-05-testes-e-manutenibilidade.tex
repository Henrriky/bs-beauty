...
Neste projeto, foram realizadas validações focadas em dois aspectos críticos: configuração de cabeçalhos de segurança HTTP e segurança de protocolo \gls{ssl}/\gls{tls}.
...
A Figura \ref{fig:security-headers-test} demonstra  o resultado obtido na análise dos cabeçalhos de segurança HTTP:
