...
\begin{longtable}{|p{1.2cm}|p{10cm}|p{4cm}|}
	...
	\hline
	RN10 & Preços e duração de serviços podem ser definidos pela profissional (autônoma) ou pela gerente (modelo comissionado). & Financeiro, \emph{Marketing} e Vendas, RH/Profissionais \\
	\hline
	...
	\hline
	RN16 & \emph{E-mails} e telefones cadastrados por clientes e profissionais devem ser únicos. & Clientes, RH/Profissionais \\
	\hline
