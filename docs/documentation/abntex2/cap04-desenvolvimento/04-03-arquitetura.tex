...
\begin{itemize}
  ...
  \item \textbf{\emph{Professionals}}: Controla os dados relacionados aos clientes da plataforma. Permite o cadastro, consulta e edição de informações do perfil dos usuários.
  ...
  \item \textbf{\emph{Blocked Times}}: Trata do registro de períodos temporários em que um profissional não está disponível (por exemplo, férias, ausências ou compromissos). Diferencia-se dos turnos regulares (
\emph{Shift}) por representar exceções pontuais que impedem o agendamento de atendimentos.
