...
import { makeBlockedTimesUseCaseFactory } from './make-blocked-times-use-case.factory'
...
function makeOffersUseCaseFactory () {
  ...
  const blockedTimesRepository = makeBlockedTimesUseCaseFactory()
  const useCase = new OffersUseCase(offerRepository, shiftRepository, appointmentRepository, serviceRepository, blockedTimesRepository)
