...
shiftRoutes.post('/', userTypeAuthMiddleware([UserType.PROFESSIONAL, UserType.MANAGER]), validateCreateShift, ShiftController.handleCreate)
shiftRoutes.put('/:id', userTypeAuthMiddleware([UserType.PROFESSIONAL, UserType.MANAGER]), validateUpdateShift, ShiftController.handleUpdateByIdAndProfessionalId)
shiftRoutes.delete('/:id', userTypeAuthMiddleware([UserType.PROFESSIONAL, UserType.MANAGER]), ShiftController.handleDelete)
