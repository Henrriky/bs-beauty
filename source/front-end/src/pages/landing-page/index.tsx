  ...
  return (
    <div className="flex flex-col items-center justify-start px-4 sm:px-8 lg:px-16">
      ...
      <img
        src={logo}
        alt="Logo"
        className="my-16 mx-auto w-40 sm:w-48 md:w-56 lg:w-64"
      />
      ...
      <div className="flex flex-col items-center gap-6 my-10 text-center">
        ...
        <Button
          ...
          className="w-64 sm:w-72 justify-center items-center"
          label="Entrar"
          type="submit"
          variant="outline"
        />
      ...
      {/* Botão final (mesmo tamanho do primeiro) */}
      <Button
        onClick={() => navigate('/login')}
        className="my-8 w-64 sm:w-72 justify-center items-center"
        label="Entrar"
        type="submit"
        variant="outline"
      />
