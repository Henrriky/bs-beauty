...
interface DeleteBlockedTimeModalProps {
  isOpen: boolean
...
export function DeleteBlockedTimeModal({
  ...
  onClose,
  onConfirm,
}: DeleteBlockedTimeModalProps) {
  return (
    <Modal
      isOpen={isOpen && !!blockedtime}
      onClose={onClose}
        ...
        <div className="mb-6">
          ...
          <div className="text-center">
            <h4 className="text-sm font-medium text-primary-0 mb-2">
              Excluir bloqueio de horário &ldquo;
              {blockedtime?.reason.slice(0, 20)}&rdquo;?
            </h4>
            <p className="text-xs text-primary-200">
              Esta ação não pode ser desfeita. O bloqueio de horário será
